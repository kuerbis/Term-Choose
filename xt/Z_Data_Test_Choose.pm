...
#{ list => $k_list, used_keys => [ qw( CONTROL_M ) ],    expected => "<1007>",     options => $k_options, },
    ...
    {
        list      => $k_list,
        used_keys => [qw( CONTROL_E )],
        expected  => "<1999>",
        options   => $k_options,
    },
    {
        list      => $k_list,
        used_keys => [qw( PAGE_DOWN )],
        expected  => "<1293>",
        options   => $k_options,
    },
    {
        list      => $k_list,
        used_keys => [qw( CONTROL_F )],
        expected  => "<1293>",
        options   => $k_options,
    },
    {
        list      => $k_list,
        used_keys => [qw( PAGE_UP )],
        expected  => "<721>",
        options   => $k_options,
    },
    {
        list      => $k_list,
        used_keys => [qw( CONTROL_B )],
        expected  => "<721>",
        options   => $k_options,
    },
    {
...
#    { list => $k_list, used_keys => [ qw( CONTROL_Space ) ],expected => "<@{[858..1143]}>", options =>    $k_options                , },
    {
        list      => $k_list,
        used_keys => [qw( CONTROL_at )],
        expected  => "<@$k_list>",
        options   => { %$k_options, default => 0 },
    },
];
...
my $options = [
    ...
    },
    {
        ...
        max_width           => 60,
        layout              => 2,
        mark                => [ 0, 10, 35, 100, 1979 ],
        no_spacebar         => [ 35, 1066, 1979 ],
        include_highlighted => 1
    },
    {
        max_height          => 20,
...
my $long = [
    ...
    },
    {
        ...
        used_keys => $keys->{long},
        expected =>
          "<1052 1118 1307 1316 1799 1843 1845 1849 1852 1909 1977 1999>",
        options => $options->[ $c_opt++ ],
    },
    {
        list      => $list->{long},
        used_keys => $keys->{long},
        expected =>
          "<1066 1126 1315 1324 1799 1857 1859 1863 1866 1917 1979 1999>",
        options => $options->[ $c_opt++ ],
    },
    {
        list      => $list->{long},
    ...
    },
    {
        ...
        used_keys => $keys->{long},
        expected =>
"<0 10 100 1066 1126 1315 1324 1799 1857 1859 1863 1866 1917 1979 1999>",
        options => $options->[ $c_opt++ ],
    },
    {
...
"<0 10 100 1066 1126 1315 1324 1799 1857 1859 1863 1866 1917 1979 1999>",
    ...
    },
    {
        ...
        used_keys => $keys->{long},
        expected =>
"<0 10 35 100 1126 1315 1324 1799 1857 1859 1863 1866 1917 1979 1999>",
        options => $options->[ $c_opt++ ],
    },
    {
        list      => $list->{long},
...
my $option_ll = [
    {
        list => $list->{ll},
        used_keys =>
          [ ('DOWN') x 3, 'SPACE', ('RIGHT') x 3, 'SPACE', 'HOME', 'ENTER' ],
        expected => "<0 3 30>",
    ...
    },
    {
        list => $list->{ll},
        used_keys =>
          [ 'END', 'SPACE', 'PAGE_UP', 'SPACE', ('UP') x 12, 'LEFT', 'ENTER' ],
        expected => "<9 21 43>",
