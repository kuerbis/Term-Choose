package Term::Choose::LineFold::CharWidthDefault;
...
#[0x0070f, 0x0070f, 0], #*) Syriac                                  Range: 0700–074F
        ...
        [ 0x007a6, 0x007b0, 0 ]
        ,    #   Thaana                                  Range: 0780–07BF
        [ 0x007eb, 0x007f3, 0 ]
        ,    #   NKo                                     Range: 07C0–07FF
        [ 0x00816, 0x00819, 0 ]
        ,    #   Samaritan                               Range: 0800–083F
        [ 0x0081b, 0x00823, 0 ],
        [ 0x00825, 0x00827, 0 ],
        [ 0x00829, 0x0082d, 0 ],
        [ 0x00859, 0x0085b, 0 ]
        ,    #   Mandaic                                 Range: 0840–085F
        ...
        [ 0x01712, 0x01714, 0 ]
        ,    #   Tagalog                                 Range: 1700–171F
        [ 0x01732, 0x01734, 0 ]
        ,    #   Hanunoo                                 Range: 1720–173F
        [ 0x01752, 0x01753, 0 ]
        ,    #   Buhid                                   Range: 1740–175F
        [ 0x01772, 0x01773, 0 ]
        ,    #   Tagbanwa                                Range: 1760–177F
        [ 0x017b4, 0x017b5, 0 ]
        ,    #   Khmer                                   Range: 1780–17FF
        [ 0x017b7, 0x017bd, 0 ],
        [ 0x017c6, 0x017c6, 0 ],
        [ 0x017c9, 0x017d3, 0 ],
        [ 0x017dd, 0x017dd, 0 ],
        ...
        [ 0x01a17, 0x01a18, 0 ]
        ,    #   Buginese                                Range: 1A00–1A1F
        [ 0x01a1b, 0x01a1b, 0 ],
        [ 0x01a56, 0x01a56, 0 ]
        ,    #   Tai Tham                                Range: 1A20–1AAF
        [ 0x01a58, 0x01a5e, 0 ],
        [ 0x01a60, 0x01a60, 0 ],
        [ 0x01a62, 0x01a62, 0 ],
        [ 0x01a65, 0x01a6c, 0 ],
        ...
        [ 0x01a7f, 0x01a7f, 0 ],
        [ 0x01ab0, 0x01abe, 0 ]
        ,    #   Combining Diacritical Marks Extended    Range: 1AB0–1AFF
        [ 0x01b00, 0x01b03, 0 ]
        ,    #   Balinese                                Range: 1B00–1B7F
        [ 0x01b34, 0x01b34, 0 ],
        [ 0x01b36, 0x01b3a, 0 ],
        [ 0x01b3c, 0x01b3c, 0 ],
        [ 0x01b42, 0x01b42, 0 ],
        ...
        [ 0x01cf8, 0x01cf9, 0 ],
        [ 0x01dc0, 0x01df9, 0 ]
        ,    #   Phonetic Extensions                     Range: 1D00–1D7F
...
#   Currency Symbols                        Range: 20A0–20CF
        [ 0x020d0, 0x020f0, 0 ]
        ,    #   Combining Diacritical Marks for Symbols Range: 20D0–20FF
        ...
        [ 0x0231a, 0x0231b, 2 ]
        ,    #   Miscellaneous Technical                 Range: 2300–23FF
        [ 0x02329, 0x0232a, 2 ],
        [ 0x023e9, 0x023ec, 2 ],
        [ 0x023f0, 0x023f0, 2 ],
        [ 0x023f3, 0x023f3, 2 ],
    ...
    #   Yijing Hexagram Symbols                 Range: 4DC0–4DFF
        [ 0x04e00, 0x09fef, 2 ]
        ,    #   CJK Unified Ideographs                  Range: 4E00–9FEF
        ...
        [ 0x0a8c4, 0x0a8c5, 0 ]
        ,    #   Saurashtra                              Range: A880–A8DF
        [ 0x0a8e0, 0x0a8f1, 0 ]
        ,    #   Devanagari Extended                     Range: A8E0–A8FF
        [ 0x0a926, 0x0a92d, 0 ]
        ,    #   Kayah Li                                Range: A900–A92F
        [ 0x0a947, 0x0a951, 0 ]
        ,    #   Rejang                                  Range: A930–A95F
        [ 0x0a960, 0x0a97f, 2 ]
        ,    #   Hangul Jamo Extended-A                  Range: A960–A97F
        [ 0x0a980, 0x0a982, 0 ]
        ,    #   Javanese                                Range: A980–A9DF
        [ 0x0a9b3, 0x0a9b3, 0 ],
        [ 0x0a9b6, 0x0a9b9, 0 ],
        [ 0x0a9bc, 0x0a9bc, 0 ],
        [ 0x0a9e5, 0x0a9e5, 0 ]
        ...
        [ 0x0aa29, 0x0aa2e, 0 ]
        ,    #   Cham                                    Range: AA00–AA5F
        [ 0x0aa31, 0x0aa32, 0 ],
        [ 0x0aa35, 0x0aa36, 0 ],
        [ 0x0aa43, 0x0aa43, 0 ],
        [ 0x0aa4c, 0x0aa4c, 0 ],
        [ 0x0aa7c, 0x0aa7c, 0 ]
        ,    #   Myanmar Extended-A                      Range: AA60–AA7F
        [ 0x0aab0, 0x0aab0, 0 ]
        ,    #   Tai Viet                                Range: AA80–AADF
        [ 0x0aab2, 0x0aab4, 0 ],
        [ 0x0aab7, 0x0aab8, 0 ],
        [ 0x0aabe, 0x0aabf, 0 ],
        [ 0x0aac1, 0x0aac1, 0 ],
        [ 0x0aaec, 0x0aaed, 0 ]
        ,    #   Meetei Mayek Extensions                 Range: AAE0–AAFF
        [ 0x0aaf6, 0x0aaf6, 0 ],
...
#   Private Use Area                        Range: E000-F8FF    private
        ...
        [ 0x0fe00, 0x0fe0f, 0 ]
        ,    #   Variation Selectors                     Range: FE00–FE0F
        [ 0x0fe10, 0x0fe1f, 2 ]
        ,    #   Vertical Forms                          Range: FE10–FE1F
        [ 0x0fe20, 0x0fe2f, 0 ]
        ,    #   Combining Half Marks                    Range: FE20–FE2F
        [ 0x0fe30, 0x0fe6f, 2 ]
...
#   Ancient Symbols                         Range: 10190–101CF
    ...
    #                                           Range: 10AA0-10ABF  not_assigned
        ...
        [ 0x11100, 0x11102, 0 ]
        ,    #   Chakma                                  Range: 11100–1114F
        [ 0x11127, 0x1112b, 0 ],
        [ 0x1112d, 0x11134, 0 ],
        [ 0x11173, 0x11173, 0 ]
        ,    #   Mahajani                                Range: 11150–1117F
        [ 0x11180, 0x11181, 0 ]
        ,    #   Sharada                                 Range: 11180–111DF
        [ 0x111b6, 0x111be, 0 ],
        [ 0x111ca, 0x111cc, 0 ],

        #   Sinhala Archaic Numbers                 Range: 111E0–111FF
        [ 0x1122f, 0x11231, 0 ]
        ,    #   Khojki                                  Range: 11200–1124F
        [ 0x11234, 0x11234, 0 ],
        [ 0x11236, 0x11237, 0 ],
        [ 0x1123e, 0x1123e, 0 ],
    ...
    #                                           Range: 114E0-1157F  not_assigned
        [ 0x115b2, 0x115b5, 0 ]
        ,    #   Siddham                                 Range: 11580–115FF
        [ 0x115bc, 0x115bd, 0 ],
        [ 0x115bf, 0x115c0, 0 ],
        [ 0x115dc, 0x115dd, 0 ],
        [ 0x11633, 0x1163a, 0 ]
        ,    #   Modi                                    Range: 11600–1165F
        [ 0x1163d, 0x1163d, 0 ],
        [ 0x1163f, 0x11640, 0 ],

        #   Mongolian Supplement                    Range: 11660–1167F
        [ 0x116ab, 0x116ab, 0 ]
        ,    #   Takri                                   Range: 11680–116CF
        [ 0x116ad, 0x116ad, 0 ],
        [ 0x116b0, 0x116b5, 0 ],
        [ 0x116b7, 0x116b7, 0 ],
    ...
    #                                           Range: 11900-119FF  not_assigned
        [ 0x11a01, 0x11a06, 0 ]
        ,    #   Zanabazar Square                        Range: 11A00–11A4F
        [ 0x11a09, 0x11a0a, 0 ],
        [ 0x11a33, 0x11a38, 0 ],
        [ 0x11a3b, 0x11a3e, 0 ],
        [ 0x11a47, 0x11a47, 0 ],
        [ 0x11a51, 0x11a56, 0 ]
        ,    #   Soyombo                                 Range: 11A50–11AAF
        [ 0x11a59, 0x11a5b, 0 ],
        [ 0x11a8a, 0x11a96, 0 ],
        [ 0x11a98, 0x11a99, 0 ],
    ...
    #                                           Range: 11B00-11BFF  not_assigned
        [ 0x11c30, 0x11c36, 0 ]
        ,    #   Bhaiksuki                               Range: 11C00–11C6F
        [ 0x11c38, 0x11c3d, 0 ],
        [ 0x11c3f, 0x11c3f, 0 ],
        [ 0x11c92, 0x11ca7, 0 ]
        ,    #   Marchen                                 Range: 11C70–11CBF
        [ 0x11caa, 0x11cb0, 0 ],
        [ 0x11cb2, 0x11cb3, 0 ],
        [ 0x11cb5, 0x11cb6, 0 ],
    ...
    #                                           Range: 11CC0-11CFF  not_assigned
        [ 0x11d31, 0x11d45, 0 ]
        ,    #   Masaram Gondi                           Range: 11D00–11D5F
        [ 0x11d47, 0x11d47, 0 ],
    ...
    #                                           Range: 16A70-16ACF  not_assigned
        [ 0x16af0, 0x16af4, 0 ]
        ,    #   Bassa Vah                               Range: 16AD0–16AFF
        [ 0x16b30, 0x16b36, 0 ]
        ,    #   Pahawh Hmong                            Range: 16B00–16B8F
         #                                           Range: 16B90-16EFF  not_assigned
        [ 0x16f8f, 0x16f92, 0 ]
        ,    #   Miao                                    Range: 16F00–16F9F
         #                                           Range: 16FA0-16FDF  not_assigned
        [ 0x16fe0, 0x16fe1, 2 ]
        ,    #   Ideographic Symbols and Punctuatio      Range: 16FE0–16FFF
        [ 0x17000, 0x187ef, 2 ]
        ,    #   Tangut                                  Range: 17000–187F1
         #                                           Range: 187F2-187FF  not_assigned
        [ 0x18800, 0x18af2, 2 ]
        ,    #   Tangut Components                       Range: 18800–18AFF
        ...
        [ 0x1b170, 0x1b2fb, 2 ]
        ,    #   Nushu                                   Range: 1B170–1B2FF
         #                                           Range: 1B300-1BBFF  not_assigned
        [ 0x1bc9d, 0x1bc9e, 0 ]
        ,    #   Duployan                                Range: 1BC00–1BC9F
...
#   Byzantine Musical Symbols               Range: 1D000–1D0FF
        ...
        [ 0x1d1aa, 0x1d1ad, 0 ],
        [ 0x1d242, 0x1d244, 0 ]
        ,    #   Ancient Greek Musical Notation          Range: 1D200–1D24F
        ...
        [ 0x1da00, 0x1da36, 0 ]
        ,    #   Sutton SignWriting                      Range: 1D800–1DAAF
        [ 0x1da3b, 0x1da6c, 0 ],
        [ 0x1da75, 0x1da75, 0 ],
        [ 0x1da84, 0x1da84, 0 ],
        [ 0x1da9b, 0x1daaf, 0 ],
    ...
    #                                           Range: 1DAB0-1DFFF  not_assigned
        ...
        [ 0x1f680, 0x1f6c5, 2 ]
        ,    #   Transport and Map Symbol                Range: 1F680–1F6FF
        [ 0x1f6cc, 0x1f6cc, 2 ],
        [ 0x1f6d0, 0x1f6d2, 2 ],
        [ 0x1f6eb, 0x1f6ec, 2 ],
        [ 0x1f6f4, 0x1f6f8, 2 ],
        ...
        [ 0x1f910, 0x1f96b, 2 ]
        ,    #   Supplemental Symbols and Pictograph     Range: 1F900–1F9FF
        [ 0x1f980, 0x1f997, 2 ],
        [ 0x1f9c0, 0x1f9c0, 2 ],
        [ 0x1f9d0, 0x1f9e6, 2 ],
  ...
  #                                           Range: 1FA70-1FFFF  not_assigned
        [ 0x20000, 0x2a6d6, 2 ]
        ,    #   CJK Unified Ideographs Extension B      Range: 20000–2A6D6
         #                                           Range: 2A6D7-2A6FF  not_assigned
        [ 0x2a700, 0x2b734, 2 ]
        ,    #   CJK Unified Ideographs Extension C      Range: 2A700–2B734
